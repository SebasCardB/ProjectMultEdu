            ...
            <div className="submenu">
              ...
              {menuOptions[activeMenu].map((option, index) => (
                <button
                  ...
                  className={`submenu-item ${option.name === 'Minijuego' ? 'minijuego-highlight' : ''}`}
                >
